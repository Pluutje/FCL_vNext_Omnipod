...
class OpenAPSFragment : DaggerFragment(), MenuProvider {
    ...
    private fun updateGUI() {
        ...
        openAPSPlugin.lastAPSResult?.let { lastAPSResult ->
            ...
            binding.profile.text = lastAPSResult.oapsProfile?.dataClassToHtml() ?: lastAPSResult.oapsProfileAutoIsf?.dataClassToHtml() ?: lastAPSResult.oapsProfileFCL?.dataClassToHtml()
