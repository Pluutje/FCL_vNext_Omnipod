...
class OmnipodDashPodStateManagerImpl @Inject constructor(
    ...
    // TODO: Move these to user preferences with GUI toggle
    private val basalCorrectionEnabled: Boolean
        get() = true  // TODO: Read from preferences
    ...
    override fun needsBasalCorrection(): Boolean {
        ...
        if (!basalCorrectionEnabled) return false
